# Generated by Powerlevel10k configuration wizard on 2026-01-31 at 15:20 CST.
...
() {
  ...
  # Use a font-agnostic prompt profile so terminals such as Termius don't require Nerd Font glyphs.
